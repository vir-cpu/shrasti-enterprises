...
export default function ShrastiEnterprisesHome() {
  ...
  />
      ...
      <section id="about-plant" style={{
        ...
        padding: "0 20px", paddingTop: 72, overflow: "hidden",
        ...
        <motion.div style={{ y: heroY, opacity: heroOpacity, maxWidth: 1280, margin: "0 auto", width: "100%", position: "relative", zIndex: 2, paddingTop: 40, paddingBottom: 40 }}>
          <div style={{ display: "grid", gap: 32, alignItems: "center" }} className="lg:grid-cols-[1fr_520px]">
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
              ...
              <motion.h1 initial={{ opacity: 0, y: 28 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2, type: "spring", stiffness: 65 }}
                style={{ fontSize: "clamp(36px, 5.5vw, 84px)", fontWeight: 900, lineHeight: 0.93, color: T.navy, letterSpacing: "-0.03em", margin: 0 }}>
                Next-Gen<br />
                <span style={{ color: T.blue }}>Packaging</span>
                <br />
              ...
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.6 }}
                style={{ display: "flex", gap: 16, flexWrap: "wrap", paddingTop: 0 }}>
