...
>
    ...
    style={{
      ...
      boxShadow: theme === "dark"
        ? `0 8px 24px rgba(212,175,55,.3), 0 2px 8px rgba(0,0,0,.3),
           inset 0 1px 0 rgba(255,255,255,.4), inset 0 -2px 3px rgba(140,104,5,.15)`
        : `0 8px 24px rgba(212,175,55,.25), 0 2px 8px rgba(0,0,0,.1),
           inset 0 1px 0 rgba(255,255,255,.45), inset 0 -2px 3px rgba(140,104,5,.20)`,
  ...
  >
    {/* Shine sweep */}
    <motion.div
      animate={{ x: ["-120%", "220%"], opacity: [0, 0.8, 0.8, 0] }}
      transition={{
        duration: 2.8, repeat: Infinity, repeatDelay: 2,
        ease: [0.25, 0.46, 0.45, 0.94], delay: 2,
      }}
      style={{
    ...
    {/* Border glow — opacity only */}
    <motion.div
      animate={{ opacity: [0.3, 0.8, 0.3] }}
      transition={{
        duration: 2.5, repeat: Infinity, ease: "easeInOut",
        repeatDelay: 1.5, delay: 2.5,
      }}
      style={{
    ...
    <motion.span
      ...
      style={{
        ...
        width: "1.2em", height: "1em", overflow: "hidden",
      }}
    >
      →
    </motion.span>
...
<motion.div
  ...
  whileTap={{ scale: 0.97 }}
  transition={{ type: "spring", stiffness: 400, damping: 25, mass: 0.5 }}
  style={{ display: "inline-flex", flex: "1 1 100%" }}
  className="cta-call-plant-wrapper"
>
  <motion.a
    ...
    style={{
      ...
      border: theme === "dark"
        ...
        : "1.5px solid rgba(26, 47, 92, 0.3)",
      background: theme === "dark"
        ? "rgba(45, 45, 45, 0.4)"
        : "rgba(26, 47, 92, 0.08)",
      backdropFilter: "blur(10px)",
      // Navy-blue-metallic in light, off-white in dark
      color: theme === "dark" ? "#F7F7F7" : "#1A2F5C",
      fontWeight: 800,
      fontSize: "clamp(11px, 2.2vw, 13px)",
      letterSpacing: "0.06em",
      textTransform: "uppercase",
  ...
  >
    ...
    <motion.div
      ...
      style={{
        ...
        border: `1px solid ${theme === "dark" ? "rgba(212,175,55,0.4)" : "rgba(26,47,92,0.35)"}`,
    ...
    <span style={{
      ...
      <motion.div
        ...
        style={{
          ...
          border: `1px solid ${theme === "dark" ? "rgba(212,175,55,0.3)" : "rgba(26,47,92,0.25)"}`,
          pointerEvents: "none",
        }}
      />
      <motion.div
        ...
        style={{
          position: "absolute", width: 16, height: 16, borderRadius: "50%",
          border: `1px solid ${theme === "dark" ? "rgba(212,175,55,0.15)" : "rgba(26,47,92,0.15)"}`,
          pointerEvents: "none",
        }}
      />
      <svg
